<template>
  <div class="container">
    <h1 class="title has-text-centered">Products List</h1>
    <div class="products is-center">
      <router-link :to="{name: 'Product', params: {id:product.id}}" v-for="product in products" :key="product.id" class="box mx-3 product">
...
export default {
  ...
  created() {
      ...
      this.products = JSON.parse(retrievedProducts);
  }
}
</script>
